...
CATEGORIES = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "connect_6", "max": 4, "text": "觀察並留意顧客資訊，作為 Clienteling 依據"},
            {"id": "connect_7", "max": 3, "text": "暫離前說明原因與時間，讓顧客有事做；回來後重新致意並感謝等待。"},
        ],
    },
    {
        "key": "CONVERT",
        ...
        "subtitle": "創造渴望・成交",
        "items": [
            {"id": "convert_1", "max": 2, "text": "介紹產品特性"},
            {"id": "convert_1b", "max": 2, "text": "將產品特性與顧客需求做連結"},
            ...
            {"id": "convert_7", "max": 2, "text": "進行交叉／追加／附加銷售"},
            {"id": "convert_7b", "max": 2, "text": "運用「三的法則」(Rule of Three) 主動準備 2 件單品（搭配款或升級替代款）放入更衣室"},
            {"id": "convert_8", "max": 3, "text": "主動介紹並推薦任一高階產品，或帶往其他品類區"},
            {"id": "convert_9", "max": 2, "text": "遇到缺碼時，主動執行「交叉銷售 (Cross-selling)」提供替代方案"},
            {"id": "convert_10", "max": 3, "text": "主動提問了解異議並協助消除（同理→確認→傳遞價值）"},
            ...
            {"id": "convert_14", "max": 3, "text": "拿取包款或錶款商品時，需佩戴手套"},
        ],
    },
    {
        "key": "CONFIRM",
        ...
        "subtitle": "結單・加值",
        "items": [
            {"id": "confirm_1", "max": 2, "text": "商品依 RL 標準包裝，並護送至收銀臺；遞交前依序 1. 檢查瑕疵、2. 拔除防盜扣、3. 確認發票明細無誤、4. 請顧客於 Sales Memo 簽名確認，再雙手將商品遞交給顧客。"},
            {"id": "confirm_2", "max": 3, "text": "提及任一建議服務：修改、售後、品牌洗滌小卡說明"},
    ...
    },
    {
        ...
        "items": [
            ...
            {"id": "continue_5", "max": 2, "text": "提及預約到店選購，或官網／會員專屬好處"},
